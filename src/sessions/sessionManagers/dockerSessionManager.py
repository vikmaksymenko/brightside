...
class DockerSessionManager(AbstractSessionManager):
    ...
    def terminate_host(self, container_id) -> None:
        """
    ...
    def find_host(self, container_id) -> BrightsideSession:
        """
    ...
    def _container_to_brightside_session(self, container) -> BrightsideSession:
        """
    ...
    def _wait_for_container_status_running(
        self, container_id, timeout_seconds=600
    ) -> Container:
        """
        ...
        logging.info(
            f"Container {container_id} did not reach Running state in {timeout_seconds} seconds, deleting container"
        )
